...
describe('DELETE /videospiele', () => {
    ...
    test('Vorhandenes Videospiel loeschen', async () => {
        // given
        const url = `/${id}`;
    ...
    test('Videospiel loeschen, aber ohne Token', async () => {
        // given
        const url = `/${id}`;
    ...
    test('Videospiel loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/${id}`;
        const token = 'FALSCH';
        const headers = { Authorization: `Bearer ${token}` }; // eslint-disable-line @typescript-eslint/naming-convention
